...
{
    /// <summary>
    /// Cass with two methods FilterByDigit & FilterByPalindromic.
    /// </summary>
    public static class ArrayExtension
    {
        ...
        public static int[] FilterByPalindromic(this int[]? source)
        {
            ...
            static bool IsMatch(int value)
            {
                ...
                int digitnum = GetNumberOfDigits(value);
                while (digitnum > 1)
                {
                    byte lustNum = (byte)(value % 10);
                    byte firstNum = (byte)(value / GetNumberOfZeroes(digitnum));
                    if (firstNum != lustNum)
                    {
                        return false;
                    }
                    ...
                    value /= 10;
                    value = value % GetNumberOfZeroes(digitnum - 1);
                    digitnum -= 2;
                }
